...
### 📡 Receive Proxies via Telegram

You can receive **free and regularly updated proxies** (HTTP, HTTPS, Socks4, Socks5) not only from this repository, but also directly through our Telegram bot.
...
### 📡 دریافت پروکسی از طریق تلگرام

شما می‌توانید **پروکسی‌های رایگان و بروز** (HTTP، HTTPS، Socks4، Socks5) را نه تنها از این مخزن، بلکه مستقیماً از طریق ربات تلگرام ما نیز دریافت کنید.
